// Estado de carregamento com o logo do Governo do Acre "sendo construído" (revelado de baixo
// para cima em loop — ver a animação `logo-build` em globals.css). Reaproveitado pelos loading.tsx
// do admin e das páginas de metadados, para uma identidade de carregamento única no portal.
export function LoadingLogo({ label = "Carregando…" }: { label?: string }) {
  return (
    <div
